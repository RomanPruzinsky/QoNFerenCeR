...
# Keycloak master admin (config/example.env: KC_ADMIN / KC_ADMIN_PASSWORD) — needed once to enable
...
COMPOSE="docker compose -f $(dirname "$0")/../../deploy/docker-compose.yml --env-file $(dirname "$0")/../../config/example.env"
